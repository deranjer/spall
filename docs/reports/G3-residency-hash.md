...
(`docs/reviews/2026-09-10-g3-residency-handling.md`). **Slices A–D implemented.**
Slice E (client residency + row 8b traversal) open. Residency is now a
**default-off** `ServeConfig` knob — row 7 is covered when on, row 8b still
depends on slice E. This document is the frozen contract; it does not certify a
gate.
