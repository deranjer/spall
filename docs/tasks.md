...
- **Increment 12+ (later).** The join-duration budget (row 11); the G4 eight-client workload + soak (rows 12–14); full-envelope player separation + region-to-region traversal (row 2).
