...
- **Increment 3+ (later).** The open rows in `docs/reports/G3.md` — resident-cache eviction, traverse-away/back, the full persistence crash-injection matrix, the join-duration budget, and the G4 eight-client workload + soak.
