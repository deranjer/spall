...
- **Increment 5+ (later).** The remaining open rows in `docs/reports/G3.md` — resident-cache eviction, traverse-away/back, the join-duration budget, and the G4 eight-client workload + soak.
