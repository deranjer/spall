...
- **Increment 9+ (later).** Slice D (default-off `ServeConfig.residency` serve-loop wiring) + slice E (client residency + row 8b traversal); the join-duration budget; the G4 eight-client workload + soak.
